...
public:
    ...
    virtual void                OLD_SetOffCenterProjectionMatrix(float fov, float zNear, float zFar, float flAspectRatio, float faimtom, float flTop, float flLeft, float flRight) = 0;
