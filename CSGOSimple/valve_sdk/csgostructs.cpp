...
CCSWeaponInfo* C_BaseCombatWeapon::GetCSWeaponData() // THIS CRASHED LAST TIME
{
	return CallVFunction<CCSWeaponInfo * (__thiscall*) (void*)>(this, 460) (this); //444
}
...
float C_BasePlayer::ForceNoFlash()
{
	static auto m_flFlashDuration = NetvarSys::Get().GetOffset("DT_CSPlayer", "m_flFlashDuration");
	return *(float*)((uintptr_t)this + m_flFlashDuration) = 0.f;
}
