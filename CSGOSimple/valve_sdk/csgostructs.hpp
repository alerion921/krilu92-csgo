...
public:
	...
	NETVAR(int32_t, m_hMyWeapons,"CBaseCombatCharacter", "m_hMyWeapons")
...
public:
	...
	NETVAR(int32_t, m_iItemDefinitionIndex, "DT_BaseCombatWeapon", "m_iItemDefinitionIndex");
...
public:
	...
	NETVAR(int32_t, dwSensitivity, "DT_BasePlayer", "dwSensitivity");
