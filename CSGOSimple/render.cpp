...
void Render::BeginScene() {
	...
	if (g_Config.GetBool("misc_watermark"))
		Render::Get().RenderText("Krilu92 Private", 10, 5, 18.f, g_Config.GetColor("color_watermark"), false, true, g_pSecondFont);

	if (g_EngineClient->IsInGame() && g_LocalPlayer && g_Config.GetBool("esp_enable"))
