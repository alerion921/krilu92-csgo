...
public:
    ...
    public:
        ...
        void ColorBox(std::string text, std::string settings_name_color);
        void ColorBox2(std::string text, std::string settings_name_color, std::string settings_name_color2);
